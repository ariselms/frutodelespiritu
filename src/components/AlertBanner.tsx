	...
	return (
		<section
			...
			<div className="max-w-7xl mx-auto">
				<Alert
					color={type}
					className="bg-slate-50 dark:bg-gray-900/50 mx-auto rounded-lg border border-slate-200 dark:border-gray-600">
					...
					<Link
						href="/biblia"
						className="text-slate-700 dark:text-white underline flex justify-center md:justify-start uppercase font-bold">
