		...
		<article
			...
			<div className="relative aspect-video sm:aspect-[2/1] lg:aspect-square lg:w-64 lg:shrink-0">
				<img
					...
					className="absolute inset-0 size-full rounded-2xl bg-transparent object-cover"
				/>
			...
			<div>
				<div className="flex items-center gap-x-4 text-xs">
					...
					<a
						href={""}
						className="relative z-10 rounded-full bg-gray-50 dark:bg-gray-500 px-3 py-1.5 font-medium text-gray-600 dark:text-gray-50 hover:bg-gray-100">
						Category
					</a>
				</div>
				...
				<div className="mt-6 flex border-t border-gray-900/5 pt-6">
					<div className="relative flex items-center gap-x-4">
						...
						<div className="text-sm/6">
							...
							<p className="text-gray-600 dark:text-gray-200">Author role</p>
						</div>
					</div>
				</div>
			</div>
