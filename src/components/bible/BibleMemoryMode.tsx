...
export default function BibleMemoryMode({
			...
			<>
				{bibleData.length > 0 && (
					<button
						...
						className="absolute right-8 top-8 text-red-500 dark:text-red-400 z-60 text-xl cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-800 rounded-full h-10 w-10 flex items-center justify-center">
						X
					</button>
				)}
				<section className="fixed inset-0 z-50 h-[100vh] w-screen backdrop-blur-md bg-slate-50/50 dark:bg-gray-950/50 m-auto">
					<Swiper
	...
	return (
		<button
			...
			<span className="bg-slate-700 hover:bg-slate-800 dark:bg-gray-900 dark:hover:bg-gray-950 border dark:border-gray-600 px-3 py-2 text-white rounded-tl-2xl rounded-bl-2xl cursor-pointer">
...
export function BibleMemoryCard({ bibleDataItem }: { bibleDataItem: any }) {
	...
	return (
		<div className="h-full flex flex-col items-center justify-center dark:text-white py-10">
			...
			<button
				className="bg-slate-700 hover:bg-slate-800 dark:bg-gray-900 dark:hover:bg-gray-950 border dark:border-gray-600 px-3 py-2 text-white rounded-lg cursor-pointer mt-16"
