			...
			<div className="flex items-center flex-wrap mb-3">
				...
				<div className="w-full flex justify-start md:mt-2">
					<input
						type="submit"
						value="Suscribirme"
						className="p-4 text-sm font-medium text-center text-white dark:text-gray-50 rounded-lg cursor-pointer bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:ring-slate-300 dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-800 transition-all duration-300 ease-in border border-slate-100 dark:border-gray-600 mt-4 md:mt-0"
						name="member_submit"
						id="member_submit"
					/>
				</div>
