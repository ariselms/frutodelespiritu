...
export default function AdminPage() {
	...
	return (
		<main className="dark:bg-gray-800">
			<article>
				<div className="bg-white dark:bg-gray-950 text-black dark:text-white dark:border-gray-700">
					<ProfileSection
							...
							{user?.role === "admin" &&
								UserNavigationWithAuth.map(
									(item: NavigationItemTypeWithAuth) => (
										<div
											key={item.name}
											className="flex flex-col justify-start rounded-2xl p-4 bg-sky-50 dark:bg-gray-700 border border-sky-100 dark:border-gray-600">
