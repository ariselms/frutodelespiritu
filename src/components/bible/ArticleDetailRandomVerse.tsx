...
export default function ArticleDetailRandomVerse() {
	return (
		<div className="mb-8 mx-4 lg:mx-0 mt-8 lg:mt-0 bg-blue-50 dark:bg-gray-800 border-1 border-blue-200 dark:border-gray-600 p-4 rounded-2xl text-black dark:text-white">
			...
			<Link
				className="inline-block px-5 py-3 text-sm font-medium text-center text-blue-50 dark:text-gray-100 rounded-2xl cursor-pointer bg-blue-700 hover:bg-blue-800 dark:bg-gray-900 dark:hover:bg-gray-800 border border-blue-100 dark:border-gray-600 focus:ring-4 focus:ring-blue-300  dark:focus:ring-gray-800 w-full"
				href={`/biblia/libros/capitulos/versiculos/${randomVerse.reference}`}>
				Leer Contexto
			</Link>
			<Link
				className="inline-block mt-4 px-5 py-3 text-sm font-medium text-center text-blue-50 dark:text-gray-100 rounded-2xl cursor-pointer bg-blue-700 hover:bg-blue-800 dark:bg-gray-900 dark:hover:bg-gray-800 border border-blue-100 dark:border-gray-600 focus:ring-4 focus:ring-blue-300  dark:focus:ring-gray-800 w-full"
				href="/biblia">
				Abrir Biblia
			</Link>
		</div>
