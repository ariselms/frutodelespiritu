				...
				<div className="max-w-3xl mx-auto py-8 px-2 xl:px-0">
					...
					<div className="grid grid-cols-5 sm:grid-cols-7 md:grid-cols-9 lg:grid-cols-10 justify-center gap-1.5">
						{BookChapters?.map((book: any) => (
							<Link
								key={book.id}
								className="bg-orange-700 hover:bg-orange-800 dark:bg-gray-900 dark:hover:bg-gray-900/50 text-white font-bold py-2 rounded-2xl text-center border-0 dark:border dark:border-gray-700"
