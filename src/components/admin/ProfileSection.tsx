	...
	return (
		<section className="container mx-auto flex flex-col items-start lg:flex-row py-8 px-4 md:-px-2">
			<div className="w-full md:w-8/12">
				{isProfile && (
					<div className="flex flex-col justify-between rounded-lg p-4 bg-slate-50 dark:bg-gray-900/50 border border-slate-100 dark:border-gray-600 w-fit-content mt-8 lg:mt-0">
