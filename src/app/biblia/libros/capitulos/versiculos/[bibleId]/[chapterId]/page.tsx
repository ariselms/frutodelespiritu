...
export default async function SingleChapterPage({
	...
	return (
		<main>
			<section className="w-full dark:bg-gray-900 text-gray-800 pb-16">
				<div className="max-w-7xl mx-auto py-8 px-2 xl:px-0">
					<Link
						...
						<svg className="w-6 h-6 text-orange-700 bolder dark:text-white mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
