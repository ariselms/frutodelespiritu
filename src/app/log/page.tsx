		...
		<main className="bg-white dark:bg-gray-800 p-2 md:p-8">
			...
			{codeSent && (
				<form onSubmit={handleCodeSubmit} className="max-w-lg mx-auto py-32">
					...
					<button
						type="submit"
						className="text-white bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 font-medium rounded-lg text-sm w-full sm:w-auto p-4 text-center dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-800 cursor-pointer dark:border-gray-600 border border-slate-100">
						{processing ? (
							<>
								<Spinner size="sm" className="mr-2" light />
								Validando...
