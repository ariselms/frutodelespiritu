	...
	return (
		<div className="mb-8 mt-4">
			<div className="p-4 grid grid-cols-2 md:grid-cols-3 h-full max-w-3xl mx-auto gap-1.5">
				{libros?.map((l: any) => (
					<Link
						className="px-0.5 py-2.5 text-sm text-center bg-slate-700 hover:bg-slate-800 dark:bg-gray-900 dark:hover:bg-gray-900/50 text-white font-bold rounded-lg dark:border dark:border-gray-700"
						key={l.id}
