		...
		<form onSubmit={handleKeywordSubmit} className="w-full flex flex-col">
			<div className="w-full mb-4">
				...
				<div className="relative">
					...
					<input
						className="block w-full lg:w-4/6 px-8 p-4 text-sm text-gray-900 border border-orange-100 rounded-2xl bg-orange-50 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500 focus-visible:outline-orange-500 dark:focus-visible:outline-gray-500"
						id="blog_search_term"
						type="search"
			...
			<div className="w-full">
				...
				<div className="flex">
					<div className="flex items-center flex-wrap gap-2">
						<div className="flex items-center border rounded-2xl p-4 border-orange-100 dark:border-gray-600 bg-orange-50 dark:bg-gray-700">
							<Radio
								color="black"
						...
						{categories.map((category) => (
							<div
								key={category.id}
								className="flex items-center border rounded-2xl p-4 border-orange-100 dark:border-gray-600 bg-orange-50 dark:bg-gray-700">
								<Radio
									color="black"
									onChange={hanldeCategoryChange}
