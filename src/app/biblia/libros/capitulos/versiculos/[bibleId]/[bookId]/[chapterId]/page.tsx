...
export default async function SingleChapterPage({
	...
	return (
		<main>
          ...
          {/* TODO: Remove the following component and create one specifically for the Bible chapters link (above), menu (will go in the center) a context menu based on h2 ids generated by JavaScript and on the right side a link to studio mode */}
          {/* Use Book?.name for the chapters */}
          {/* Use Chapter?.content for the menu */}
          {/* Studio mode link will have a modal with information about the feature coming up */}
