...
export default function ContentLeftTwoImagesRight({
  ...
  return (
		<section className="fade-in-move-up bg-orange-50 dark:bg-gray-800 border-y border-orange-300 dark:border-gray-800 pt-10 pb-16">
			<div className="gap-16 py-8 px-4 mx-auto max-w-screen-xl flex flex-col-reverse items-center lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
				...
				<div className="relative flex justify-center">
					<svg
						className="hidden lg:block fill-orange-200 dark:fill-gray-900 absolute z-10 w-125 h-125 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 rotate-12"
