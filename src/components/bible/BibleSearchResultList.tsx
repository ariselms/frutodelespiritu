...
export const SearchResultItem = ({ result, bibleId }: { result: any; bibleId: string }) => {
  ...
  const verseId = bibleVerseParts[2];
	...
	return (
		<div className="bg-slate-50 dark:bg-gray-700 border border-slate-100 dark:border-gray-600 rounded-lg p-4 flex flex-col justify-between">
			<div>
			...
			<Link
				...
				className="inline-block text-center rounded-lg text-slate-50 dark:text-gray-50 bg-slate-700 hover:bg-slate-800 dark:bg-gray-900 dark:hover:bg-gray-800 px-4 py-2 border border-slate-100 dark:border-gray-600 mt-8 transition-all">
				Leer contexto
			</Link>
		</div>
	);
