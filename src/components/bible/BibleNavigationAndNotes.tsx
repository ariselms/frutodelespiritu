		...
		<nav className="flex items-center justify-between mb-6 last:mt-6 max-w-[80ch]">
			{previousChapterParams && (
				<Link
					...
					className="rounded-lg border border-slate-100 dark:border-gray-600 bg-slate-700 hover:bg-slate-800 dark:bg-gray-900 dark:hover:bg-gray-800 px-5 py-1 font-bold text-slate-50 dark:text-gray-50 flex items-center transition-all text-xs sm:text-sm md:text-base">
					<svg
						className="w-6 h-6 text-slate-50 bolder dark:text-white"
						aria-hidden="true"
